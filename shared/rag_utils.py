...
def rag_load_markdown_documents(md_dir: Path) -> list[MarkdownDocument]:
    """TODO charger les documents Markdown depuis un dossier
...
def rag_chunk_documents_by_chars(
    ...
    progress_desc: str = "Découpage des documents",
) -> list[RAGChunk]:
    ...
    - show_progress : activer/désactiver tqdm
    - progress_desc : libellé de la barre tqdm
    ...
    iterator = documents
    if show_progress:
        iterator = tqdm(documents, desc=progress_desc, unit="doc")
